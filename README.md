...
# Additional Info
## Terms of Use
The purpose of this website is to compile a list of eBook and Audiobook download/streaming links from external websites.
The user is responsible for any actions taken in response to the Rave eBook Search Engine's results.
...
## Privacy Policy
The Rave Book Search Engine does not collect or retain any personally identifiable information.
